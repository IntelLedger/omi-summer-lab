# -*- coding: utf-8 -*-
#
# OMI documentation build configuration file, created by
...
htmlhelp_basename = 'OMISummerLabDoc'
...
latex_documents = [
  (master_doc, 'omi_summer_lab.tex', u'OMI Summer Lab Documentation',
...
man_pages = [
    (master_doc, 'omisummerlab', u'OMI Summer Lab Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'OMISummerLab', u'OMI Summer Lab Documentation',
   author, 'OMISummerLab', 'One line description of project.',
   'Miscellaneous'),
]
